          ...
          <table className="table table-bordered">
            <tbody>
              <tr>
                ...
                <th>Check Out :</th>
                <td>
                  {moment(checkIn?.checkOut).format("DD-MM-YYYY")}
                </td>
              </tr>
              <tr>
      ...
      <div className="bg-white rounded-bottom p-4 border">
        <div className="d-flex gap-4 justify-content-between align-items-center w-100">
          <table className="table table-bordered">
            <thead>
              <tr>
                <th className="max-w-25" scope="col">S.No</th>
      ...
      <div className="bg-white rounded-bottom p-4 border">
        <div className="w-100 mb-4">
          ...
          <table className="table table-bordered">
            <thead>
              <tr>
                <th className="max-w-25 text-center" scope="col">S.No</th>
                <th scope="col" className="text-center">
                  Room
                </th>
                <th scope="col" className="text-center">
        ...
        <div className="w-100 mb-4">
          ...
          <table className="table table-bordered">
            <thead>
              <tr>
                <th className="text-center max-w-25" scope="col">S.No</th>
                <th scope="col" className="text-center">
                  Item
                </th>
                <th scope="col" className="text-center">
        ...
        <table className="table table-bordered">
            <tbody>
              <tr>
                ...
                <td className="text-end w-10">{total = roomTotal + roomServiceTotal}/- Tk</td>
              </tr>
              <tr>
              ...
              <tr className="bg-warning-light">
                ...
                <td className="text-end w-10">{total - percentage(GST, total) - totalPayed}/- Tk</td>
              </tr>
            </tbody>
          </table>
      </div>
