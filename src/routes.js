...
const routes = [
  ...
  { path: '/manage-rooms/room-types', name: 'Rooms', element: RoomTypes },
  { path: '/manage-rooms/add-room-types', name: 'Add Room', element: AddRoomTypes },
  { path: '/check-in/online-check-in', name: 'online Check In', element: OnlineCheckIn },
