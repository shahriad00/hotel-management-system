...
const AddRoomTypes = React.lazy(() =>
  import("./views/manageRooms/addRoomTypes")
);
const UpdateRoomTypes = React.lazy(() =>
  import("./views/manageRooms/updatedRoomType")
);
...
const ViewOnlineBooking = React.lazy(() =>
  import("./views/checkIn/viewOnlineBooking")
);

// Check out
const CheckOut = React.lazy(() => import("./views/checkOut/checkOut"));
const AllCheckOuts = React.lazy(() =>
  import("./views/checkOut/allCheckOuts.js")
);
const UpdateGuestInfo = React.lazy(() =>
  import("./views/checkOut/updateGuestInfo")
);
...
const UpdateReference = React.lazy(() =>
  import("./views/reference/updateReference")
);
...
const TotalExpense = React.lazy(() =>
  import("./views/totalExpense/allExpense")
);
...
const ChangePassword = React.lazy(() =>
  import("./views/settings/changePassword")
);
...
const routes = [
  ...
  {
    path: "/manage-rooms/edit-room/:id",
    name: "Edit Room",
    element: UpdateRoom,
  },
  { path: "/manage-rooms/room-types", name: "Room Types", element: RoomTypes },
  {
    path: "/manage-rooms/add-room-types",
    name: "Add Room Types",
    element: AddRoomTypes,
  },
  {
    path: "/manage-rooms/edit-room-types/:id",
    name: "Edit Room Types",
    element: UpdateRoomTypes,
  },
  {
    path: "/check-in/online-booking",
    name: "Online Booking",
    element: OnlineBooking,
  },
  {
    path: "/check-in/all-online-booking",
    name: "All online bookings",
    element: AllOnlineBooking,
  },
  { path: "/check-in/add-check-in", name: "Add Check In", element: AddCheckIn },
  {
    path: "/check-in/all-check-ins",
    name: "All Check In",
    element: AllCheckIns,
  },
  ...
  {
    path: "/check-in/view-online-booking/:id",
    name: "View Online Booking",
    element: ViewOnlineBooking,
  },
  ...
  },
  {
    path: "/total-income",
    name: "Total Income",
    element: localStorage.getItem("hms-user") ? checkRole(TotalIncome) : null,
  },
  {
    path: "/total-expense",
    name: "Total Expense",
    element: localStorage.getItem("hms-user") ? checkRole(TotalExpense) : null,
  },
  {
    path: "/total-report",
    name: "Total Report",
    element: localStorage.getItem("hms-user") ? checkRole(TotalReport) : null,
  },
];
